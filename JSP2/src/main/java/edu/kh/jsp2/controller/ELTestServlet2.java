...
// Servlet 클래스로 등록하기 위한 절차는 어떻게 되는가? extends / 어노테이션
@WebServlet("/el/scope")
...
//		   범위객체.getAttribute("key");
		req.setAttribute("requestValue", "request scope 객체에 새팅한 값");
//		범위 객체에 세팅한 값(속성) 형태
//		K=V
//		requestValue=request scope 객체에 세팅한 값
		
//		3. session scope
//		- 클라이언트가 서버에 첫 요청 시 서버 쪽에 생성되는 객체
